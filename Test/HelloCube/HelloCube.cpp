...
#error Unsupported platform
    ...
    auto indexBuffer = Rx::CreateBuffer(Rx::BufferDesc::IndexBuffer(sizeof(cubeIndices), Rx::MemoryType::GPU_ONLY, cubeIndices));
    ...
    auto setLayout = Rx::CreateSetLayout(
        Rx::SetLayoutDesc().add(Rx::Binding::ConstantBuffer(0, Rx::PipelineStage::VERTEX)).setDebugName("CubeSetLayout"));
    ...
    auto descriptorPool = Rx::CreateDescriptorPool(Rx::DescriptorPoolDesc::Persistent(setLayout, 3) // POOL policy, max 3 sets
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glm::mat4 proj   = glm::perspective(glm::radians(60.0f), (float)currentWidth / (float)currentHeight, 0.1f, 100.0f);
