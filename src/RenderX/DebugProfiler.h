...
#define PROFILE_GPU_CALL(name) PROFILE_SCOPE_CAT(name, "GPU")
...
#define PROFILE_MEMORY_ALLOC(size) PROFILE_MEMORY("MemoryAllocation", size)
...
#define PROFILE_DESCRIPTOR(name) PROFILE_SCOPE_CAT(name, "Descriptor")

#define PROFILE_SWAPCHAIN(name) PROFILE_SCOPE_CAT(name, "Swapchain")

#define PROFILE_SYNC(name) PROFILE_SCOPE_CAT(name, "Synchronization")

#define PROFILE_VALIDATION(name) PROFILE_SCOPE_CAT(name, "Validation")

#define PROFILE_COMMAND_BUFFER(name) PROFILE_SCOPE_CAT(name, "CommandBuffer")
...
#define PROFILE_FRAME_END(frameIndex) ProLog::PerformanceMarker::EndEvent("Frame_" + std::to_string(frameIndex))
